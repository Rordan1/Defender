...
## Will need to cancel subscription if only using for practice.
 ...
 ## Workload Protection Alerts are specific to threats detected in individual resources, showcasing the nature of the threat, and remediation steps.
   ...
   ![alt text](Screenshot_13-3-2025_14719_portal.azure.com.jpeg)

 ## Provides insights into which resources in an environment are protected and monitored by Defender.
   
![alt text](Screenshot_13-3-2025_14740_portal.azure.com.jpeg)
...
![alt text](Screenshot_13-3-2025_141318_portal.azure.com.jpeg) 
   ...
   ![alt text](Screenshot_25-2-2025_1230_portal.azure.com.jpeg) 
  ...
  ## It helps organizations manage sensitive data, ensure regulatory compliance, and govern data across on-premises, multicloud, and SaaS environments. 
   ...
   ![alt text](Screenshot_25-2-2025_12210_web.purview.azure.com.jpeg) 
   
   ## Purview includes tools for data classification, retention policies, eDiscovery, and risk management.

   ![alt text](Screenshot_25-2-2025_12225_purview.microsoft.com.jpeg) 

   ## Steps to create an account.
   
   
   ![alt text](Screenshot_25-2-2025_12354_portal.azure.com.jpeg) 

   ## Account creation workflow continued
   
   
   ![alt text](Screenshot_25-2-2025_12756_portal.azure.com.jpeg) 
   
   ## Confirm upgrades
   
   ![alt text](Screenshot_25-2-2025_121327_web.purview.azure.com.jpeg) 
...
![alt text](firefox1.png)
 ...
 ![alt text](Screenshot_25-2-2025_122128_purview.microsoft.com.jpeg) 
 
 
 ## Available Solutions
 
 ![alt text](Screenshot_25-2-2025_131051_purview.microsoft.com.jpeg)
